...
Level: "Sedentary",
Description: "Little to no exercise, such as a desk job with no additional physical activity ",
Factor: 1.2,
},
{
    ...
    },
    {
        ...
        },
        {
            ...
            },
            {
                ...
                Description: "Hard daily exercise and physical job or two times a day training ",
                Factor: 1.9,
                },
]
...
export const CalculationContext = createContext<CalculationContextProps>({
  ...
  selectedGender: 'female', // Default value for selectedGender
  setSelectedGender: (gender: string) => {},
  selectedActivityLevel: 'Little to no exercise', // Default value for selectedActivityLevel
  setSelectedActivityLevel: (activityLevel: string) => {},
  selectedNutritionGoal: 'maintain current weight', // Default value for selectedNutritionGoal
...
export const CalculationProvider = (
  { children }: { children: React.ReactNode },) => {
    ...
    const [selectedActivityLevel, setSelectedActivityLevel] = useState("Little to no exercise");
    const [selectedNutritionGoal, setSelectedNutritionGoal] = useState("maintain current weight");
